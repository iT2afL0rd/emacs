...
;; Notes: This file has been modified by zhengyu li in Fri 28 Sep 2012

;; Author: Jim Blandy <jimb@cyclic.com>
;; Maintainer: Jim Blandy <jimb@cyclic.com>
;; Created: Mon  6 Sep 1993
;; Updated: Fri 28 Sep 2012 by zhengyu li
;; Version: 1.7
;; Keywords: unix
...
(defconst dired-tar-bzip2ed-tarfile-regexp
  (format "\\(%s\\)\\'"
          (mapconcat 'regexp-quote
  ...
  (let ((tar-file-dir (file-name-directory tar-file))
    ...
    (dired-tar-run-command
     (cond
      ...
      ;; Does it look like a gzipped compressed tar file?
      ...
      ;; Does it look like a bzip2ed compressed tar file?
      ((string-match dired-tar-bzip2ed-tarfile-regexp tar-file)
       (format "%s < %s | tar %s%s -"
